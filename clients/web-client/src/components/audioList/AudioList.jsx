...
import { apiUrl } from "../../BackendApiUrlConfig.js";
...
const AudioList = ({ isFavoriteAudioFiles }) => {
  ...
  const isPlaylistDownloaded = useRef(false);
    ...
    if (
      ...
      fetch(
        ...
        .then(data => {
          ...
          if (totalCount === 0) {
            isPlaylistDownloaded.current = true;
          }
  ...
  // useEffect(() => {
  //   if (
  //     !isPlaylistDownloaded.current &&
  //     !isPlaylistDownloading &&
  //     (!localPlaylistData.id ||
  //       (localPlaylistData.audioFiles.length === 0 &&
  //         localPlaylistData.id === null)) &&
  //     !(localPlaylistData.id && localPlaylistData.countOfAudio === 0)
  //   ) {
  //     setTimeout(() => {
  ...
  //     isPlaylistDownloaded.current = true;
  //   }
  // }, [localPlaylistData, isPlaylistDownloading]);
